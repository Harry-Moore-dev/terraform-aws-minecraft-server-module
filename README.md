...
| <a name="input_mc_modpack"></a> [mc\_modpack](#input\_mc\_modpack) | The modpack to install on the Minecraft server | `string` | `""` | no |
| <a name="input_mc_modpack_entrypoint"></a> [mc\_modpack\_entrypoint](#input\_mc\_modpack\_entrypoint) | The entrypoint jar for the modpack | `string` | `""` | no |
